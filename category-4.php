<?php get_header(); ?>
            ...
            <div class="mu_content">
                    ...
                    <div class="mu_select_univer">
                        ...
                        <form method="get" class="main-search" id="search_form">
                            <div class="sumo_wr"> 
                                ...
                                if(single_term_title('', false)!='Польша') $strc = single_term_title('', false);
                                else $strc = 'Все города';
                                ?>
                                <script>
                                    function setSity(){
                                        $('.CaptionCont').html('<?=$strc?>');
                                    }
                                </script>
                                    ...
                                    <div class="mu_academy_txt_wrap">
                                        ...
                                        <div class="mu_academy_txt_footer">
                                            <div class="mu_academy_txt_footer_list">
                                                ...
                                                <div>
                                                    <?php if(get_post_meta( get_the_ID(), 'uf1', true )){ ?><span><img src="<?=get_template_directory_uri()?>/images/point.png" alt="point" class="mu_point"><?=get_post_meta( get_the_ID(), 'uf1', true )?></span><?php } ?>
                                                    <?php if(get_post_meta( get_the_ID(), 'uf2', true )){ ?><span><img src="<?=get_template_directory_uri()?>/images/point.png" alt="point" class="mu_point"><?=get_post_meta( get_the_ID(), 'uf2', true )?></span><?php } ?>
                                                    <?php if(get_post_meta( get_the_ID(), 'uf3', true )){ ?><span><img src="<?=get_template_directory_uri()?>/images/point.png" alt="point" class="mu_point"><?=get_post_meta( get_the_ID(), 'uf3', true )?></span><?php } ?>
                                                </div>
                                                <div>
                                                    <?php if(get_post_meta( get_the_ID(), 'uf4', true )){ ?><span><img src="<?=get_template_directory_uri()?>/images/point.png" alt="point" class="mu_point"><?=get_post_meta( get_the_ID(), 'uf4', true )?></span><?php } ?>
                                                    <?php if(get_post_meta( get_the_ID(), 'uf5', true )){ ?><span><img src="<?=get_template_directory_uri()?>/images/point.png" alt="point" class="mu_point"><?=get_post_meta( get_the_ID(), 'uf5', true )?></span><?php } ?>
                                                    <?php if(get_post_meta( get_the_ID(), 'uf6', true )){ ?><span><img src="<?=get_template_directory_uri()?>/images/point.png" alt="point" class="mu_point"><?=get_post_meta( get_the_ID(), 'uf6', true )?></span><?php } ?>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="mu_study">
                    ...
                    <h2><span>---------------</span><?=wp_get_terms_meta( get_queried_object_id(), 'header', true )?><span>---------------</span></h2>
